...
// El cliente mencionó k+a@marmoles.com como correo, pendiente de confirmar; mientras, se mantiene este.
      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-col footer-marca">
            <Link to="/" className="footer-logo">
              <img src="/logo-ka-claro.png" alt="K+A Mármoles" width="117" height="36" />
            </Link>
            <address className="footer-datos">
              <span>Carretera Río Hondo KM 14,</span>
              <span>Huixquilucan, Estado de México, C.P. 55770</span>
        ...
        <div className="footer-bottom">
          ...
          <ul className="footer-social" aria-label="Redes sociales">
            <li>
              {/* TODO: URL real de Instagram pendiente del cliente. */}
              <a href="#" aria-label="K+A Mármoles en Instagram" target="_blank" rel="noopener noreferrer">
            ...
            <li>
              <a href="https://www.facebook.com/p/KA-M%C3%A1rmoles-100089582127608/"
                aria-label="K+A Mármoles en Facebook" target="_blank" rel="noopener noreferrer">
            ...
            <li>
              {/* TODO: URL real de Pinterest pendiente del cliente. */}
              <a href="#" aria-label="K+A Mármoles en Pinterest" target="_blank" rel="noopener noreferrer">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
